...
class reporteLoader:
    ...
    def operaUnifierUDR():
        ...
        jsonUnifier = uniController.loadReportUnifier(token)
    ...
    def operaUnifierBp():
        print("Se cargara bp record Unifier")
        token = uniController.getTokenUnifier()
        qa = uniController.fetchBPrecordList(token)
...
def main():
    ...
    print("4)Trae Bp record")
    print("5)Muestra shells")
    ...
    if opc == '1':
        ...
        qa = reporteLoader.operaUnifierBp()
        print(qa)
    elif opc =='5':
         token = uniController.getTokenUnifier()
         jsonUnifier = uniController.getShell(token)
         print(jsonUnifier)
